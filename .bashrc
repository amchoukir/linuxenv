# Adding IOS environment variables
export USER_PATH="~/bin"				# Extra paths.
export EDITOR=vim				        # Preferred editor.
#export TAGS_TYPE=ctags				    # Tag type for vim
...
#
umask 022                               # By default no write by group and other
export TMOUT=0                         # disable logout 
...
#CDETS Home
#export CDETS_INSTALL_DIR=/usr/local
